...
public class RunAsyncComputableFeature {

    public static Void saveEmployeesWithCustomExecutor(File jsonFile) throws ExecutionException, InterruptedException {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        saveEmployeesWithCustomExecutor(new File("employees.json"));
    }
}
